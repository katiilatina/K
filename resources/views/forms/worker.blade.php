...
<form class="needs-validation" action="{{ action('FormWorkersController@form') }}" method="POST" style="width: 50%; margin-left: 25%; margin-top: 10%;">
{{csrf_field()}}
...
<div align="center">
  ...
  <button class="btn btn-primary" type="button" onclick="window.location='/workers'">Назад</button>
