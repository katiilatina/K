...
@endif
  ...
  <header class="masthead mb-auto">
    <div class="inner">
      <h3 class="masthead-brand">Список избранных</h3>
  ...
  <main role="main" class="inner cover">
    <h1 class="cover-heading">Всего лишь заполни форму</h1>
    <p class="lead">Да, да, тебе не показалось, чтобы стать избранным надо заполнить форму. Тот, кто попадет в список, получит конфетку!</p>
    <p class="lead">
      <a href="/form" class="btn btn-lg btn-secondary">Заполнить форму</a>
    </p>
  </main>
